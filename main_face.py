...
#cv dnn detector
from deep_sort.face_detector import face_detector
...
class VideoTracker(object):
    ...
    def image_track(self, im0):
        ...
        # Inference
        t1 = time.time()
        boxes, confs = face_detector(im0)
        #print("No of faces detected,",len(boxes))
        t2 = time.time()
        # get all obj ************************************************************
...
if __name__ == '__main__':
    ...
    # input and output
    parser.add_argument('--input_path', type=str, default='videos/Naga_Chaitanya.mp4', help='source')  # file/folder, 0 for webcam
